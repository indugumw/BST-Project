class Binary_Search_Tree:
  ...
  # Recursive function that determines whether the value goes on the right or left side of the tree.
  ...
  # Recursive function that removes a node from the tree
  ...
  def __recursive_pre_order(self, node):
    s = " "
    #Add root node value to the string
    s = s + str(node.value) + ", "
    #Add left nodes from the tree to the string
    if node.left is not None:
      s = s + self.__recursive_pre_order(node.left)
    #Add right nodes from the tree to the string
    if node.right is not None:
  ...
  #Recursive function that changes the values of a binary tree into a list
  ...
  def pre_order(self):
    ...
    if self.__root is None:
        ...
        string = "[ "
        string = string + self.__recursive_pre_order(self.__root)[:-2]
        string = string + " ]"
        return string
  ...
  def post_order(self):
    ...
    if self.__root is None:
        ...
        string = "[ "
        string = string + self.__recursive_post_order(self.__root)[:-2]
        string = string + " ]"
        return string
